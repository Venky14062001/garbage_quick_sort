...
class GarbageQuickSortRobotROSMoveIt:
    def __init__(self):
        ...
        # store the smooth traj by gqsJointSmooth node
        self.smooth_traj = JointTrajectory()
        ...
        # create a publisher to publish the rough trajectory generated by MoveIt!
        self.rough_traj_pub = rospy.Publisher(
            "/garbage_quick_sort/gqsTrajRough", 
            JointTrajectory, queue_size=1
        )
        ...
        # create a subscriber for getting the smooth trajectory from the gqsJointSmooth node
        self.smooth_traj_sub = rospy.Subscriber(
            "/garbage_quick_sort/gqsTrajSmooth", JointTrajectory,
            self.smooth_traj_callback
        )
    ...
    # callback for the smooth traj result
    def smooth_traj_callback(self, traj_msg):
        self.smooth_traj = traj_msg
